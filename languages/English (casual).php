...
"updatesAvailable" => array("class" => "info", "message" => "A new version of eso (<strong>%s</strong>) is available for download. You have version {$versions["eso"]}. <strong><a href='https://github.com/esoforum'>Get it now</a></strong>!"),
