...
"hour" => "hour",
"hours" => "hours",
"httpsInfo" => "Whether or not to force HTTPS. This will not substitute a web certificate.",
...
"updateCurrentResultsInfo" => "Amount of time by which conversations are updated (post information) in an existing search. (30 = 30 seconds.)",
...
"uploadPackagesInfo" => "Whether or not admins can upload plugin and skin packages to your forum. Don't keep this enabled if you don't trust your admins.",
...
"loginsMinuteError" => array("class" => "warning", "message" => "The amount of login attempts must be a value greater than 0."),
...
"passwordLengthError" => array("class" => "warning", "message" => "The minimum password length must be a value greater than 0."),
