<?php
// formatter.php
// Sets up a lexer and processes plain text, outputting a formatted string.
// Formatter classes (e.g. Formatter_Bold) are defined for each type of formatting.  They each add "modes" to the lexer.
